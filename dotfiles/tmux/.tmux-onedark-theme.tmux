...
set "window-status-format" "#[fg=$onedark_white,bg=default] #I  #W  "
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_visual_grey,nobold]#[fg=$onedark_white,bg=$onedark_visual_grey,nobold] #I  #W #[fg=$onedark_visual_grey,bg=default,nobold,nounderscore,noitalics]"
