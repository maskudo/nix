...
return {
  ...
  -- stylua: ignore
	keys = {
		...
		{ "<leader>bw", function() Snacks.picker.grep_word() end, desc = "Visual selection or word", mode = { "n", "x" }, },
		...
		{ "<leader>ft", function() Snacks.picker() end, desc = "Picker", },
		...
		{ "<leader>ls", function() Snacks.picker.lsp_symbols({layout = {preset = "telescope", preview = "main"}}) end, desc = "LSP Symbols", },
		...
		{ "<leader>fm", function() Snacks.picker.marks({filter= {cwd = true}}) end, desc = "Marks", mode = { "n", "v" }, },
	},
}
